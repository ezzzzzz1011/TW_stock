        ...
        if st.session_state.data and st.session_state.data.get("success"):
           ...
           # --- 修正版：徹底隔離變數與中文文字 ---
            ...
            <table class="styled-table">
                <thead><tr><th>Value Level</th><th>Suggested Price</th></tr></thead>
                <tbody>
                    <tr><td>Cheap (10%)</td><td>{p_cheap_val} or Below</td></tr>
                    <tr><td>Fair (7%)</td><td>{p_cheap_val} ~ {p_fair_val}</td></tr>
                    <tr><td>Expensive (5%)</td><td>Above {p_high_val}</td></tr>
                </tbody>
            </table>
            """
